import { a8 as useCandidates, o as useVendors, q as useUpdateEntityStage, s as useCreateApprovalItem, r as reactExports, a9 as CANDIDATE_STAGES, j as jsxRuntimeExports, P as PageLoadingSpinner, t as getSupabaseCreds, L as Link, g as Button, v as stageRequiresApproval, e as Badge, f as cn, w as ue, aa as useCreateCandidate } from "./index-DFzRDTvK.js";
...
import { H as HealthBadge, a as getRelativeTime } from "./HealthBadge-rW7saCOP.js";
...
import { L as Lock, u as useForm } from "./index.esm-nsmifm_c.js";
...
function CandidatesPage() {
  ...
  const [vendorFilter, setVendorFilter] = reactExports.useState("");
  ...
  const filtered = candidates.filter((c) => {
    const matchText = c.name.toLowerCase().includes(filter.toLowerCase()) || (c.skills ?? "").toLowerCase().includes(filter.toLowerCase()) || (c.title ?? "").toLowerCase().includes(filter.toLowerCase());
    const matchVendor = !vendorFilter || c.vendorId === vendorFilter || // Fall back to assignedRecruiter which may hold vendorId for older records
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", "data-ocid": "candidates-page", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-2 border-b border-border bg-card flex flex-wrap items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
          value: filter,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Select,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "__all__", children: "All Vendors" }),
              vendors.map((v) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectItem, { value: v.id, children: [
                v.name,
                v.company ? ` · ${v.company}` : ""
              ] }, v.id))
