import { c as createLucideIcon, O as useJobs, K as useClients, o as useVendors, aj as useResumes, ak as useSubmissions, R as useCreateJob, T as useUpdateJob, ad as useUpdateSubmissionStage, r as reactExports, a0 as useSubmissionsForJob, j as jsxRuntimeExports, U as Users, g as Button, m as Briefcase, w as ue, al as getStageLabel, e as Badge, C as ChevronRight, am as useUpdateJobStatus, an as STAGE_ORDER, ae as ALLOWED_STAGE_TRANSITIONS, X, M as useCreateClient, ao as useQueryClient, ap as useBenchRecords, aq as useMatchBench, L as Link, I as PIPELINE_STAGE_LABELS, ar as isValidTransition, as as getStageColor } from "./index-CyRa7n7i.js";
import { P as PageHeader } from "./PageHeader-BiaDBCE5.js";
import { A as AppModal } from "./AppModal-CgULATLy.js";
import { E as EmptyState } from "./EmptyState-tnItS6cR.js";
import { I as Input } from "./input-CtjgPDoP.js";
import { L as Label } from "./label-JYCuHusD.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-DtmCMXPR.js";
import { S as Skeleton } from "./skeleton-BpKAFoue.js";
import { T as Textarea } from "./textarea-BAPxRJyG.js";
import { P as Plus } from "./plus-CK7ytsQ-.js";
import { M as MapPin } from "./map-pin-C0rci7DC.js";
import { C as ChevronDown } from "./chevron-down-CcmY2tHN.js";
import { M as MessageSquare } from "./message-square-5FzWTfr-.js";
import { R as RefreshCw } from "./refresh-cw-Bm-pXsUH.js";
import { C as Clock } from "./clock-Cq34Stte.js";
import { H as History } from "./history-DtfbRf_s.js";
import { E as ExternalLink } from "./external-link-CxD63V2l.js";
import "./index-Cdx46MVr.js";
import "./index-311JCrE2.js";
import "./index-CM_x0ih7.js";
import "./index-CyfbzPGF.js";
import "./index-z1c89Qta.js";
import "./check-CNeQC7sC.js";
/**
...
const IndianRupee = createLucideIcon("indian-rupee", __iconNode$4);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function InlineToast({
  ...
  const bg = t.type === "success" ? "bg-emerald-600" : t.type === "error" ? "bg-rose-600" : "bg-amber-500";
...
function useInlineToast() {
  ...
  return { toast: toast2, showToast, dismissToast };
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "dialog",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 w-full max-w-sm mx-4 bg-card border border-border rounded-lg shadow-elevated", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-3 border-b border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-card-foreground font-display", children: "Confirm Rejection" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
              "Rejecting",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: candidateName }),
              " ",
              "from",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: jobTitle }),
              "."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: reason, onValueChange: setReason, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: REJECTION_REASONS.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: r, className: "text-xs", children: r }, r)) })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-end gap-2 px-4 py-3 border-t border-border bg-muted/20", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "ghost",
...
function SubmissionDetailPanel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-3 border-b border-border bg-card shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-card-foreground font-display truncate", children: submission.candidateName ?? "—" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate", children: submission.jobTitle ?? "—" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-4 space-y-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            submission.daysInStage > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-0.5", children: label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-card-foreground truncate", children: value ?? "—" })
          ] }, label)) }),
          submission.rejectionReason && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md border border-rose-200 bg-rose-50 dark:border-rose-800 dark:bg-rose-900/20 px-3 py-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-semibold text-rose-700 dark:text-rose-400 uppercase tracking-wider mb-0.5", children: "Rejection Reason" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-rose-800 dark:text-rose-300", children: submission.rejectionReason })
          ] }),
          submission.pipelineHistory && submission.pipelineHistory.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(History, { className: "h-3.5 w-3.5 text-muted-foreground" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-semibold text-muted-foreground uppercase tracking-wider", children: "Pipeline History" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative pl-4 space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1.5 top-0 bottom-0 w-px bg-border" }),
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 flex-wrap", children: [
                          h.fromStage && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: getStageLabel(h.fromStage) }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "h-2.5 w-2.5 text-muted-foreground" })
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                            {
                              ...
                              style: { color: toColor },
                              children: getStageLabel(h.toStage)
                            }
                          )
                        ] }),
                        h.rejectionReason && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-rose-600 dark:text-rose-400 mt-0.5", children: [
                          "Reason: ",
                          h.rejectionReason
                        ] }),
          ...
          submission.notes && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-1", children: "Notes" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-card-foreground leading-relaxed whitespace-pre-wrap", children: submission.notes })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-1", children: [
            submission.candidateId && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                to: "/candidates",
            ...
            submission.jobId && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                to: "/jobs",
                className: "flex items-center gap-1 text-xs text-primary hover:underline",
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-foreground truncate leading-tight mb-0.5", children: submission.candidateName ?? "—" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground truncate mb-1", children: submission.jobTitle ?? "—" }),
            topSkills.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1 mb-1.5", children: topSkills.map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-1 flex-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 flex-wrap", children: [
                daysInStage > 7 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-0.5 text-[9px] px-1.5 py-0.5 rounded-full bg-amber-100 text-amber-700 border border-amber-200 dark:bg-amber-900/20 dark:text-amber-400 dark:border-amber-700 font-medium", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-2.5 w-2.5" }),
                  daysInStage,
                  "d"
                ] }) : daysInStage > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[9px] text-muted-foreground px-1.5 py-0.5 rounded-full bg-muted border border-border", children: [
                  daysInStage,
                  "d"
                ] }) : null,
                vendorName ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] px-1.5 py-0.5 rounded-full bg-blue-50 text-blue-600 border border-blue-200 dark:bg-blue-900/20 dark:text-blue-400 dark:border-blue-800 font-medium truncate max-w-[80px]", children: vendorName }) : submission.vendorId ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] px-1.5 py-0.5 rounded-full bg-blue-50 text-blue-600 border border-blue-200 dark:bg-blue-900/20 dark:text-blue-400 dark:border-blue-800 font-medium", children: "Vendor" }) : null
              ] }),
              allowed.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "select",
                {
                  value: "",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "Move to…" }),
                    allowed.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: s, children: getStageLabel(s) }, s))
                  ]
                }
              )
            ] })
...
function KanbanColumn({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-2.5 py-2 border-b border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-semibold text-foreground uppercase tracking-wider truncate flex-1", children: label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-2 space-y-2 min-h-[120px]", children: [
          submissions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground/50", children: "Drop here" })
            }
          ) : submissions.map((sub) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            KanbanCard,
            {
              submission: sub,
              vendorName: sub.vendorId ? vendorMap.get(sub.vendorId) : void 0,
              topSkills: sub.resumeId ? resumeSkillsMap.get(sub.resumeId) ?? [] : [],
              onDragStart,
              onStageChange,
              onClick: onCardClick
            },
          ...
          submissions.length > 0 && isDragOver && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 rounded border-2 border-dashed border-primary/40 bg-primary/5 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-primary", children: "Drop here" }) })
        ] })
      ]
    }
  );
}
function KanbanStatsBar({ submissions }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        totalSubmissions === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground italic mr-2", children: "No submissions yet — submit resumes to jobs to populate the pipeline" }),
        STAGE_ORDER.map((s) => {
          var _a;
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              title: count === 0 ? `No submissions in ${PIPELINE_STAGE_LABELS[s]}` : void 0,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: (_a = PIPELINE_STAGE_LABELS[s]) == null ? void 0 : _a.split(" ")[0] }),
...
function KanbanBoard({
  ...
  const [draggedSubId, setDraggedSubId] = reactExports.useState(null);
  const [draggedFromStage, setDraggedFromStage] = reactExports.useState(null);
  const [dragOverStage, setDragOverStage] = reactExports.useState(null);
  const [pendingRejection, setPendingRejection] = reactExports.useState(null);
  const [selectedSub, setSelectedSub] = reactExports.useState(null);
  const filtered = jobId ? submissions.filter((s) => s.jobId === jobId) : submissions;
  ...
  function handleDragStart(e, subId, fromStage) {
    setDraggedSubId(subId);
    setDraggedFromStage(fromStage);
    e.dataTransfer.effectAllowed = "move";
  }
  function handleDragOver(e, toStage) {
    e.preventDefault();
  ...
  function handleStageChangeFromCard(sub, toStage) {
  ...
  function handleRejectionConfirm(reason, notes) {
    if (!pendingRejection) return;
    onSubUpdate(pendingRejection.sub, pendingRejection.toStage, reason, notes);
    setPendingRejection(null);
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(KanbanStatsBar, { submissions: filtered }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-x-auto overflow-y-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "flex gap-3 p-4 h-full min-h-[400px]",
        style: { minWidth: "max-content" },
        children: STAGE_ORDER.map((stage) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          KanbanColumn,
          {
            stage,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      RejectionModal,
      {
        ...
        candidateName: (pendingRejection == null ? void 0 : pendingRejection.sub.candidateName) ?? "Candidate",
        jobTitle: (pendingRejection == null ? void 0 : pendingRejection.sub.jobTitle) ?? "this job",
        onConfirm: handleRejectionConfirm,
        onCancel: () => setPendingRejection(null)
      }
    ),
    selectedSub && /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function SubmissionListView({
  ...
  const [pendingRejection, setPendingRejection] = reactExports.useState(null);
  const [selectedSub, setSelectedSub] = reactExports.useState(null);
  const filtered = (jobId ? submissions.filter((s) => s.jobId === jobId) : submissions).filter((s) => {
    if (!search) return true;
    const q = search.toLowerCase();
    return (s.candidateName ?? "").toLowerCase().includes(q) || (s.jobTitle ?? "").toLowerCase().includes(q);
  });
  function handleStageChange(sub, toStage) {
    const fromStage = sub.pipelineStage;
    if (!fromStage) return;
    if (!isValidTransition(fromStage, toStage)) {
      showToast(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 border-b border-border bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Input,
      {
        value: search,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto", children: filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-48 text-sm text-muted-foreground", children: search ? "No matching submissions found." : "No submissions yet for this view." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-[1fr_1fr_90px_160px_60px_100px] gap-2 px-3 py-1.5 bg-muted/20 border-b border-border text-[10px] font-semibold text-muted-foreground uppercase tracking-wider sticky top-0 z-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Candidate" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Job" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Vendor" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Stage" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Days" }),
      ...
      filtered.map((sub) => {
        ...
        const allowed = stage ? ALLOWED_STAGE_TRANSITIONS[stage] ?? [] : [];
        const vendorName = sub.vendorId ? vendorMap.get(sub.vendorId) : void 0;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground truncate min-w-0", children: vendorName ?? (sub.vendorId ? "Vendor" : "—") }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  children: sub.daysInStage > 0 ? `${sub.daysInStage}d` : "—"
                }
              ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 w-full max-w-xl mx-4 bg-card border border-border rounded-lg shadow-elevated flex flex-col max-h-[90vh]", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto p-4 space-y-4", children: step === 1 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-md border border-emerald-200 bg-emerald-50 dark:border-emerald-800 dark:bg-emerald-900/20 px-3 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-emerald-800 dark:text-emerald-300 leading-relaxed", children: [
              ...
              " Paste the job requirement message you received on WhatsApp."
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-card-foreground font-display", children: job.title }),
                      job.location && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground flex items-center gap-1 mt-0.5", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-xs text-foreground font-medium", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(IndianRupee, { className: "h-3 w-3 text-primary" }),
                    formatRateDisplay(job)
                  ] }),
                  job.roleSummary && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed line-clamp-2", children: job.roleSummary }),
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground truncate", children: m.candidateName }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground truncate", children: m.vendorName }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground truncate", children: m.role }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground truncate", children: m.skill }),
...
function JobsPage() {
  ...
  const { data: allSubmissions = [], refetch: refetchSubmissions } = useSubmissions();
  const createJob = useCreateJob();
  ...
  const [viewMode, setViewMode] = reactExports.useState("jobs");
  const [localSubmissions, setLocalSubmissions] = reactExports.useState([]);
  ...
  const resumeSkillsMap = new Map(
    resumes.map((r) => {
      const skills = Array.isArray(r.extractedSkills) ? r.extractedSkills.slice(0, 3) : typeof r.extractedSkills === "string" && r.extractedSkills ? r.extractedSkills.split(",").map((s) => s.trim()).filter(Boolean).slice(0, 3) : [];
      return [r.id, skills];
    })
  );
  ...
  function handleSubUpdate(sub, toStage, reason, notes) {
    ...
    setLocalSubmissions(
      (prev) => prev.map(
        (s) => s.id === sub.id ? {
          ...
          daysInStage: 0,
          lastStageChangeAt: (/* @__PURE__ */ new Date()).toISOString()
        } : s
      )
    );
    const update = {
    ...
    updateStage.mutate(
      { id: sub.id, update, jobId: sub.jobId ?? void 0 },
      {
        onSuccess: () => {
  ...
  const pipelineJobId = viewMode === "kanban" || viewMode === "list" ? selectedJobId ?? null : null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", "data-ocid": "jobs-page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      PageHeader,
      {
        ...
        actions: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center border border-border rounded-md overflow-hidden", children: [
            {
              mode: "jobs",
            ...
            {
              mode: "kanban",
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SquareKanban, { className: "h-3.5 w-3.5" }),
              label: "Kanban"
            },
            {
              mode: "list",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          (viewMode === "kanban" || viewMode === "list") && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-auto flex items-center gap-2 pb-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-muted-foreground", children: [
    ...
    viewMode === "jobs" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-hidden flex", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
    ...
    ] }) : viewMode === "kanban" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-hidden flex flex-col bg-background", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-4 py-2 border-b border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground shrink-0", children: "Filter by job:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            value: selectedJobId ?? "",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "All jobs" }),
              jobs.filter((j) => j.status === "open").map((j) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: j.id, children: j.title }, j.id))
            ]
          }
        )
      ] }),
    ...
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-hidden flex flex-col bg-background", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-4 py-2 border-b border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground shrink-0", children: "Filter by job:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(InlineToast, { toast: inlineToast, onDismiss: dismissToast })
  ] });
}
export {
  JobsPage as default,
