import { c as createLucideIcon, J as useJobs, G as useClients, M as useCreateJob, N as useUpdateJob, r as reactExports, j as jsxRuntimeExports, g as Button, m as Briefcase, v as ue, e as Badge, C as ChevronRight, a3 as useUpdateJobStatus, X, H as useCreateClient, a4 as useQueryClient, a5 as useSubmissionsForJob, a6 as useUpdateSubmission, U as Users, a7 as useBenchRecords, a8 as useMatchBench, L as Link } from "./index-D6lnvgsb.js";
import { P as PageHeader } from "./PageHeader-5D43PSPg.js";
...
import { M as MapPin } from "./map-pin-BzrDa39_.js";
import { C as ChevronDown } from "./chevron-down-C0JKR27X.js";
import { M as MessageSquare } from "./message-square-C-ZN7McA.js";
import { R as RefreshCw } from "./refresh-cw-CPpLo09K.js";
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs font-semibold text-foreground uppercase tracking-wider", children: "Candidate Pipeline" }),
          !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "h-4 text-[10px] px-1.5", children: [
            submissions.length,
            " ",
        ...
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-9 w-full rounded" }, i)) }) : submissions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "rounded-md border border-border bg-muted/20 px-3 py-4 text-center",
            "data-ocid": "pipeline-empty",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "0 profiles shared for this role" })
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md border border-border overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-[1fr_160px_80px] gap-2 px-3 py-1.5 bg-muted/30 border-b border-border", children: ["Candidate", "Pipeline Stage", "Date"].map((h) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
          ...
          submissions.map((sub) => {
            ...
            const stageColorClass = STAGE_COLOR_MAP[stageValue] ?? "bg-muted text-muted-foreground border-border";
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-foreground truncate", children: sub.candidateName || "—" }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "select",
                      {
                        ...
                        children: [
                          ...
                          PIPELINE_STAGES.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: s, children: s }, s))
                        ]
                      }
                    ),
                    stageValue && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: new Date(sub.submittedAt).toLocaleDateString("en-US", {
                    month: "short",
                    day: "numeric"
                  }) })
                ]
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-4 space-y-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CandidatePipelinePanel, { job }),
