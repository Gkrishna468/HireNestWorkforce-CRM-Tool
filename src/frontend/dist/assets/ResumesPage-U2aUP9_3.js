...
import { T as Trash2 } from "./trash-2-DY21H9a9.js";
import { E as Eye } from "./eye-DuN1qdAb.js";
...
function SubmitJobModal({ resume, onClose, onSubmitted }) {
  ...
  const openJobs = jobs.filter(
    (j) => ["open", "active"].includes((j.status ?? "").toLowerCase())
  );
