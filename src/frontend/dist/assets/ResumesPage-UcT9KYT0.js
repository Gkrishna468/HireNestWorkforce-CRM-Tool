import { c as createLucideIcon, r as reactExports, aj as useResumes, j as jsxRuntimeExports, t as getSupabaseCreds, L as Link, ah as FileText, w as ue, X, O as useJobs, ax as scoreJobMatch, m as Briefcase, g as Button, ay as Search, az as useCreateResume, aA as useCheckDuplicateResume, aB as useFindSimilarCandidates, o as useVendors, ag as useCreateSubmission, aC as useDeleteResume, aD as useListSubmissionsForResume, e as Badge, aE as extractTextFromDocx, aF as extractTextFromPdf, aG as parseResumeText, aH as extractNameFromFilename } from "./index-DFzRDTvK.js";
import { I as Input } from "./input-BZpd_191.js";
import { L as Label } from "./label-CbJncwjG.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, C as ChevronUp } from "./select-BSD0MVi1.js";
import { S as Skeleton } from "./skeleton-CTIvbLz2.js";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-BQ_CpcNZ.js";
import { T as Textarea } from "./textarea-CMLMyBn3.js";
import { C as CircleAlert } from "./circle-alert-Bvo_yld9.js";
import { A as ArrowLeft, P as Phone } from "./phone-CEJLEcw3.js";
import { U as Upload } from "./upload-C3RbafbQ.js";
import { U as User } from "./user-Drx1FQAW.js";
...
import { T as Trash2 } from "./trash-2-CwDTkHV7.js";
import { E as Eye } from "./eye-BE8Cf90J.js";
...
const SquareCheck = createLucideIcon("square-check", __iconNode$1);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function SubmitJobModal({ resume, onClose, onSubmitted }) {
  ...
  const [selectedJobIds, setSelectedJobIds] = reactExports.useState(/* @__PURE__ */ new Set());
  ...
  const openJobs = (() => {
    const filtered = allJobs.filter((j) => {
      ...
      return s === "open" || s === "active" || s === "open - active" || s === "open-active";
    });
  ...
  function toggleAll() {
    if (selectedJobIds.size === openJobs.length) {
      setSelectedJobIds(/* @__PURE__ */ new Set());
    } else {
  ...
  async function handleSubmit() {
    if (selectedJobIds.size === 0) {
      ue.error("Please select at least one job to submit to.");
      return;
    }
  ...
  const allSelected = openJobs.length > 0 && selectedJobIds.size === openJobs.length;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: "fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm",
      "data-ocid": "submit-job-modal",
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl shadow-2xl w-full max-w-md flex flex-col max-h-[90vh]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3 px-6 py-4 border-b border-border flex-shrink-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-5 space-y-4 overflow-y-auto flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              ...
              openJobs.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  onClick: toggleAll,
            ...
            jobsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: [0, 1, 2].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-9 w-full rounded-md" }, i)) }) : openJobs.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-3 py-2.5 rounded-lg bg-muted/50 border border-border", children: [
                ...
                children: openJobs.map((job) => {
                  ...
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-shrink-0 text-primary", children: checked ? /* @__PURE__ */ jsxRuntimeExports.jsx(SquareCheck, { className: "h-4 w-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Square, { className: "h-4 w-4 text-muted-foreground" }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex-1 min-w-0", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-foreground block truncate", children: job.title }),
                          (job.clientName || job.rateAmount) && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground block truncate", children: [
                            job.clientName,
                            job.rateAmount && `${job.rateAmount} ${job.rateType ?? ""}`.trim()
                          ].filter(Boolean).join(" · ") })
                        ] }),
                        job.status && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] px-1.5 py-0.5 rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20 flex-shrink-0 capitalize", children: job.status })
                      ]
                    },
                    job.id
                  );
            ...
            selectedJobIds.size > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-primary font-medium", children: [
              selectedJobIds.size,
              " job",
              selectedJobIds.size > 1 ? "s" : "",
              " ",
              "selected",
              selectedJobIds.size > 1 && " — will create one submission per job"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-xs font-medium text-foreground", children: [
              ...
              Select,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                    ...
                    vendors.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-2 text-xs text-muted-foreground", children: "No vendors found. Add vendors in the Vendors section." }) : vendors.map((v) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectItem, { value: v.id, children: [
                      v.name,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2 px-6 py-4 border-t border-border flex-shrink-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: isSubmitting ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                ...
                selectedJobIds.size > 1 ? `Submit to ${selectedJobIds.size} Jobs` : "Submit Profile"
              ] })
            }
          )
        ] })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-5 p-4 sm:p-6 max-w-full min-h-0", children: [
    ...
    submitResume && /* @__PURE__ */ jsxRuntimeExports.jsx(
      SubmitJobModal,
      {
        ...
        onSubmitted: (count) => {
          ue.success(
            count > 1 ? `Submitted to ${count} jobs successfully` : "Submitted successfully!",
            {
              description: submitResume.candidateName ? `${submitResume.candidateName}'s profile has been submitted.` : void 0
            }
          );
        }
      }
